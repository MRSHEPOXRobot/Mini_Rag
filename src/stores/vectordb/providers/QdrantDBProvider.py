from qdrant_client import models, QdrantClient #moduls from documentation of qdrant
...
class QdrantDBProvider(VectorDBInterface):
    ...
    def insert_many(self, collection_name: str, texts: list,
        ...
        if metadata is None:
            metadata = [None] * len(texts) # أنت بتعمل list بنفس عدد الـ texts في حالة ان المستخدم مداش metadata
